...
<template>
    <div class="flex flex-col gap-6">
        <div class="card">
            ...
            <ReceiveDocTable :data="receiveDocs" :loading="loading" :totalRecords="totalRecords" :currentPage="currentPage" :pageSize="pageSize" mode="history" showCloseDateTime @page-change="onPageChange" @view-detail="viewDetail" />
        </div>
